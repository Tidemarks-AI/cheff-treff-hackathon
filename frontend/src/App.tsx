    ...
    <div className="flex min-h-screen flex-col bg-background">
      <header className="sticky top-0 z-50 flex h-16 shrink-0 items-center border-b border-border bg-background/80 px-6 backdrop-blur-xl">
        <Link to="/" className="flex items-center gap-2.5 hover:opacity-80">
          ...
          <span
            className="text-lg font-light tracking-[0.25em] text-foreground uppercase"
            style={{
              fontFamily:
        ...
        <nav className="ml-8 flex items-center gap-1">
          <Link
            to="/changes"
            className="rounded-md px-3 py-1.5 text-xs font-medium text-muted-foreground transition-colors hover:bg-accent hover:text-foreground [&.active]:bg-accent [&.active]:text-foreground"
          >
            Changes
          </Link>
          <Link
