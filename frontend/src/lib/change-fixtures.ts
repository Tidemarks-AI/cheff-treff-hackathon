import type { ChangeRequest, ForecastSeries } from "./changes-api"

export const FORECAST_BASE: ForecastSeries = {
  months: [
...
export function createLocalFixture(): ChangeRequest {
  return {
    id: `local_${Date.now()}`,
    status: "pending",
    ...
    reasoning_evidence: [
      { field: "monthly_amount", clause: "§3.1", text: "Die monatliche Miete beträgt EUR 12.000,00 netto zzgl. Nebenkosten" },
      { field: "term_months", clause: "§2.1", text: "Das Mietverhältnis beginnt am 01.07.2026 und läuft über 36 Monate" },
      { field: "notice_period", clause: "§12.3", text: "Kündigungsfrist von 3 Monaten zum Vertragsende" },
      { field: "start_date", clause: "§2.1", text: "Mietbeginn: 01.07.2026" },
      { field: "vendor", clause: "§1.1", text: "Vermieter: Berlin Offices GmbH, Friedrichstraße 123, 10117 Berlin" },
    ],
    policy_triggered: ["fixed_cost_threshold_3k"],
    policy_satisfied: false,
    policy_message: "This change exceeds the €3,000/month threshold for fixed costs. Finance approval required.",
